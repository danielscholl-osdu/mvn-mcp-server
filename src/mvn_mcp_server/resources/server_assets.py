    ...
    def _get_prompt_info(self) -> List[Dict[str, Any]]:
        ...
        return [
            ...
            },
            {
                ...
                "arguments": [
                    {"name": "service_name", "type": "str", "required": True, "description": "Name of the service to analyze"},
                    {"name": "workspace", "type": "str", "required": False, "description": "Path to workspace (defaults to ./service_name)"}
                ],
            ...
            },
            {
                ...
                "arguments": [
                    {"name": "service_name", "type": "str", "required": True, "description": "Name of the service to plan updates for"},
                    {"name": "priorities", "type": "List[str]", "required": False, "description": "Priority levels to include (defaults to ['CRITICAL', 'HIGH'])"}
                ],
                ...
                "tools": [
                    {
                        ...
                        "parameters": ["dependency", "version", "packaging", "classifier"]
                    },
                    {
                ...
                "tools": [
                    {
                        ...
                        "parameters": ["workspace", "scan_mode", "severity_filter", "max_results"]
                    },
                    {
